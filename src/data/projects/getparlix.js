...
export default {
  ...
  tagline: 'Your business. Your data. Powered by intelligent AI.',
  summary:
    'An AI chatbot and voice assistant that answers customer questions, books appointments, and sends confirmations on any website — 24/7, in under two seconds. One line of code, no developer needed.',
  ...
  what: {
    ...
    body: [
      'GetParlix is an AI-powered chatbot and voice assistant that lives on a business’s website and works like a tireless front-desk employee. It answers customer questions, books appointments, and sends confirmations around the clock — in natural, human-sounding conversation.',
      'The whole platform is built so that any business can go live in under ten minutes. No developer, no website redesign, no new software to learn. The owner completes a short onboarding wizard about their business, pastes a single line of code into their site, and the assistant is ready to talk to customers.',
    ],
    pull: 'GetParlix turns a static website into a 24/7 conversation that captures leads, answers questions, and fills the calendar — automatically.',
  },

  problem: {
    label: 'The problem',
    title: 'The gap after 5 p.m.',
    body: 'Customers don’t stop needing a business at 5 p.m. — but the front desk clocks out. Calls go unanswered, after-hours enquiries go cold, and staff burn hours every day repeating the same answers. That gap quietly leaks bookings, revenue, and trust, every single day.',
    stats: [
  ...
  audiences: [
    { title: 'Clinics & healthcare', body: 'Dental, medical, and wellness practices booking appointments and answering patient questions — on HIPAA-eligible infrastructure.', icon: 'Stethoscope' },
    ...
    { title: 'Local & home services', body: 'Trades and service providers that miss calls while on the job but still need to book work.', icon: 'Wrench' },
    { title: 'Agencies & multi-client', body: 'Agencies deploying branded, white-label assistants across many client websites from one platform.', icon: 'Building2' },
  ],
  audienceNote:
    'Because each client’s data is isolated and the assistant is trained purely on that business’s own information, the same platform adapts to almost any industry without custom rebuilds.',
  ...
  steps: [
    ...
    { k: 'Paste one line of code', v: 'A single snippet drops into the website — works with WordPress, Wix, Squarespace, Shopify, or any custom site.' },
    { k: 'Bookings come in', v: 'Customers chat, ask, and book 24/7. Confirmations go out automatically by email, SMS, and WhatsApp.' },
  ],

  features: [
    { title: '24/7 AI chat', body: 'Natural-language conversations for bookings, questions, and reschedules — any hour, any day, answered in under two seconds.', icon: 'MessagesSquare' },
    ...
    { title: 'White-label widget', body: 'Match brand colors, logo, and tone — and remove the GetParlix watermark on paid plans.', icon: 'Palette' },
  ...
  dashboard: {
    ...
    intro: 'Every business gets a self-service control center — no technical knowledge needed — to run every aspect of its assistant.',
    items: [
      { k: 'Documents', v: 'Upload knowledge like PDFs, Word docs, and text files that train the assistant on the business.' },
      { k: 'Onboarding', v: 'A guided wizard capturing the business profile, services, products, pricing, policies, FAQs, and booking preferences.' },
  ...
  benefits: [
    ...
    { k: 'More booked appointments', v: 'Turns website visitors into scheduled appointments inside the conversation, with double-booking protection.' },
    { k: 'Less repetitive work', v: 'Handles the routine FAQs that eat hours of staff time each day, freeing people for higher-value work.' },
    { k: 'Live in minutes, not months', v: 'A ten-minute setup with one line of code — no developer, redesign, or new platform to learn.' },
    { k: 'On-brand & trustworthy', v: 'A white-label experience that matches the business, backed by enterprise-grade security.' },
    { k: 'Decisions from real data', v: 'Analytics reveal what customers ask, when they book, and where revenue comes from.' },
  ],
  ...
  security: {
    intro: 'Because businesses trust GetParlix with their customer conversations, security is built into the foundation rather than bolted on.',
    items: [
      { k: 'Per-client data isolation', v: 'Every business’s data is sandboxed and separated from every other client.' },
  ...
  stack: {
    intro:
      'A modern, self-hosted, multi-tenant platform. The stack was chosen for real-time responsiveness, AI-driven understanding, and reliable scaling across many independent clients.',
    groups: [
      {
        group: 'Frontend',
        rows: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['WebSockets', 'Real-time, low-latency streaming for live chat and voice interactions.'],
      ...
      },
      {
        group: 'AI, voice & data',
        rows: [
          ['OpenAI (language + realtime voice)', 'Natural-language understanding, conversational responses, and real-time voice.'],
  ...
  ownership: {
    ...
    intro: 'I designed, built, and shipped GetParlix end-to-end — owning every layer from the first wireframe to the running production system.',
    items: [
      ...
      { k: 'AI integration', v: 'Integrated conversational AI, vector-based knowledge retrieval, and a real-time voice assistant into a single, coherent experience.' },
      { k: 'Deployment & operations', v: 'Containerized the platform, configured the reverse proxy, TLS, and workflow automation, and deployed it as a live, multi-tenant service.' },
    ],
  },
